...
public class Oxoacidos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(28, 155, 100, 18);
        getContentPane().add(jSeparator1);
        jSeparator1.setBounds(0, 62, 810, 10);

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(254, 254, 254));
        jLabel2.setText("Oxigeno(O)");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(315, 155, 90, 18);

        getContentPane().add(cbxnm);
        cbxnm.setBounds(168, 150, 106, 27);

        jLabel5.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(254, 254, 254));
        jLabel5.setText("+");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(140, 155, 16, 18);
        ...
        jLabel11.setBounds(403, 155, 16, 18);

        jButton1.setText("Combinar");
        getContentPane().add(jButton1);
        jButton1.setBounds(30, 220, 492, 60);

        jTextField2.setEditable(false);
        getContentPane().add(jTextField2);
        jTextField2.setBounds(426, 143, 94, 42);
        ...
        jLabel3.setBounds(168, 120, 90, 18);

        jLabel4.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(254, 254, 254));
        jLabel4.setText("compuesto");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(426, 120, 79, 18);
